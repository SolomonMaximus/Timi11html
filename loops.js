...
{
    //s er stytting fyrir section, má heita hvað sem er, þetta verður section,, sem er returnað frá addSection falli
...
/// FOR LOOP MEP CONTINUE

{
    const s= addSection("Æfing 2: For loop með continue", "Pretna countdown frá 10 en sleppa tölunni 5 ")
    for (let i = 10; i >=0; i--){
        if (i === 5) {
            continue
        }
